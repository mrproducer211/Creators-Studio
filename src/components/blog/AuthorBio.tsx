...
export default function AuthorBio() {
  return (
    <div
      className="rounded-2xl p-6 md:p-8 flex flex-col sm:flex-row items-center sm:items-start gap-5 my-10"
      style={{ background: "#FFFFFF", border: "1px solid #EDE8DF" }}
    >
      {/* Avatar / Brand Image */}
      <div className="relative w-16 h-16 rounded-full overflow-hidden flex-shrink-0 bg-[#1C3A2F] flex items-center justify-center border border-[#EDE8DF]">
        <Image
      ...
      <div className="flex flex-col gap-3 text-center sm:text-left flex-grow">
        <div className="flex flex-col gap-1">
          ...
          <h4 className="text-[16px] font-bold text-[#1C3A2F] m-0">
            NHP Bangkok Team
          </h4>
        </div>

        <p className="text-[13px] font-light leading-relaxed text-gray-500 m-0">
        ...
        <div className="pt-2">
          <Link
            href="/explore"
            className="text-[12px] font-bold no-underline hover:underline transition-colors"
            style={{ color: "#C9A84C" }}
          >
