  ...
  return (
    <form onSubmit={onSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div className="flex flex-col gap-6">
        ...
        {errors._form && (
          <p className="text-[12px] px-3 py-2 rounded-lg flex items-center gap-1.5" style={{ background: "rgba(224,82,82,0.1)", color: "#E05252" }}><AlertTriangle className="w-3.5 h-3.5" /> {errors._form}</p>
        )}
