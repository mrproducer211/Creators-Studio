...
export const T_MATCH: Record<"en" | "th" | "zh", MatchTranslations> = {
  en: {
    ...
    landingCTA: "Begin Neighborhood Match →",
    landingTitle2: "Neighborhood Match",
    ...
    resultOfAutoFinder: "Result of Neighborhood Match",
  ...
  th: {
    ...
    landingTitle2: "จับคู่ย่านที่ใช่ (Neighborhood Match)",
    ...
    resultOfAutoFinder: "ผลลัพธ์จาก Neighborhood Match",
  ...
  zh: {
    ...
    landingCTA: "开始自动匹配社区 →",
    landingTitle2: "街区匹配 (Neighborhood Match)",
    stepOf: "步骤 {step} / 6",
    next: "下一步",
    back: "上一步",
    finish: "生成生活方式画像",
    ...
    resultOfAutoFinder: "街区匹配结果 (Neighborhood Match)",
